...
@section('content')
    @include('layouts.superAdminNavbars.headers.cardsSubAgentList')
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <form method="GET" action="" class="float-right" accept-charset="UTF-8" role="form"
                                        ...
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <div class="input-group-append">
                                                <a class="btn btn-outline-danger" href="{{ url('superadmin/superadmin-clear-sub-agent-list') }}"
                                                    style="z-index: 0;" type="button" id="button-addon2"><i
                                                    ...
                                                    <td class="text-right">
                                                        <div class="media align-items-center">
                                                            ...
                                                            <div class="btn-group dropstart">
                                                                <button type="button" class="btn btn-icon btn-outline-secondary text-dark dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li><a class="dropdown-item"
                                                                        style="cursor: pointer;" href="/superadmin/wallet/{{ @$user->id}}"><i
                                                                            class="fa fa-wallet"></i> Modify Wallet</a></li>
                                                                    <li><a class="dropdown-item"
                                                                        style="cursor: pointer;" href="/superadmin/wallet/{{ @$user->id}}"><i
                                                                    ...
                                                                    <li><a class="dropdown-item"
                                                                        ...
                                                                        href="/superadmin/wallet/{{ @$user->id}}/logs"><i
                                                                            class="fa fa-history"></i> Transaction Logs</a></li>
                                                                    <li><a class="dropdown-item"
                                                                        style="cursor: pointer;"
                                                                        href="/superadmin/comission/{{ @$user->id}}/logs"><i
                                                                            class="fa fa-history"></i> Comission Logs</a></li>
                                                                    <li><a class="dropdown-item"
                                                                        style="cursor: pointer;"
                                                                        onclick="resetpassword({{ @$user->id }},'{{ @$user->name }}','reset')"><i
                                                                            class="fa fa-lock"></i> Reset Password</a></li>
                                                                    <li><a class="dropdown-item"
                                                                           style="cursor: pointer;"
                ...
                <div class="modal-body">
                    ...
                    <div class="py-3 text-center">
                        ...
                        <p>Please Input your password
                            for confirmation</p>
                        <form id="reset-password-form" action="{{route('superadmin-reset-password') }}" method="post">
                            @csrf
                ...
                <div class="modal-content bg-gradient-danger">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="py-3 text-center">
                            ...
                            <p>Please Input your password
                                for confirmation</p>
                            <form id="deactivate-form" action="{{ auth()->user()->user_level == 'admin' ? route('admin-players-change-status') : route('players-change-status') }}" method="post">
                                @csrf
                                <div class="form-group col-sm-12">
                                    <div class="input-group">
                                        <input id="password" placeholder="Enter password" required="required"
