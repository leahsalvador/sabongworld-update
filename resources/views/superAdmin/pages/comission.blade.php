...
@section('content')
    @include('layouts.superAdminNavbars.headers.cardsComission')
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-header bg-transparent">
                            ...
                            @endif
                            <h3 class="mb-0">
                                <i class="fa fa-money-check-alt"></i>Commission Loading Station
                            </h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12">
                                    <div class="card card-stats border-dark">
                                        <div class="card-body">
                                            <form action="{{ route('superadmin-comission-modify')}}" id="wallet-form"
                                                  method="POST" onsubmit="hideModal()">
                                                @csrf
                                                <div id="loading_form_body" class="card-body">
                                                    <div class="form-group"><label for="company"><strong>Transaction
                                                                Type</strong></label> <select id="transaction_type"
                                                                                              required="required"
                                                                                              name="transaction_type"
                                                                                              class="form-control">
                                                            <option value="">Select a transaction type</option>
                                                            <option value="withdraw" selected="selected">Agent
                                                                Commission
                                                                Cashout
                                                            </option>
                                                        </select>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-sm-6"><label><strong
                                                                    id="loadUsernameLabel">Cashout From</strong></label>
                                                            <input type="text" class="form-control form-control" hidden
                                                                   name="load_to" id="load-to" value="{{ @$user->id }}">
                                                        ...
                                                        <div class="form-group col-sm-6">
                                                            ...
                                                            <div class="input-group">
                                                                <div class="input-group-prepend">
                                                                    <span
                                                                        class="input-group-text form-control-sm">₱</span>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-sm-12"><label
                                                                for="details"><strong>Details</strong></label> <input
                                                ...
                                                <div class="card-footer">
                                                    <button type="button"
                                                            class="btn btn btn-outline-success float-right"
                                                                ...
                                                                <div class="modal-content bg-gradient-danger">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="py-3 text-center">
                                                                            ...
                                                                            <h4 class="heading mt-4">Please Input your
                                                                                password
                                                                                for confirmation</h4>
