@extends('layouts.appSuperAdmin') @section('content') @include('layouts.superAdminNavbars.headers.cardsWallet')
                                    ...
                                    <div class="card card-stats border-dark">
                                        <div class="card-body">
                                            <div id="loading_form_body" class="card-body">
                                                <form
                                                    action="{{ route('superadmin-wallet-modify')}}"
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-sm-6">
                                                            ...
                                                            <input type="text" class="form-control form-control" hidden name="load_to" id="load-to" value="{{ @$user->id }}">
                                                            <input type="text" class="form-control form-control" value="{{ @$user->username }}" readonly>
                                                            ...
                                                            <div class="modal-content bg-gradient-danger">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="py-3 text-center">
                                                                        ...
                                                                        <h4 class="heading mt-4">Please Input your password
                                                                            for confirmation</h4>
                                                                        <div class="form-group col-sm-12">
                                                                            <div class="input-group">
                                                                                <input id="password"
