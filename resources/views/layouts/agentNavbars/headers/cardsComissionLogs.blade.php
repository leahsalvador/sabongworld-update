    ...
    <div class="container-fluid">
        <div class="header-body">
            ...
            <div class="header pb-4">
                <div class="container-fluid">
                    <div class="header-body">
                        <h6 class="h2 text-white d-inline-block mb-0"><i class="fa fa-clipboard-list"></i>  {{__('COMMISSION LOGS')}}</h6>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            ...
                            <a href="{{ auth()->user()->user_level == 'admin' ? route('admin-agent-comission') : route('agent-comission') }}" type="button"
                                ...
                                class="btn btn-outline-secondary mt-3 mb-0 "><i class="fas fa-cogs"></i> {{__('Manage Comission')}}</a>
                                @endif
