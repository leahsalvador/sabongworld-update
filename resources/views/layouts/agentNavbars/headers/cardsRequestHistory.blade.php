    ...
    <div class="container-fluid">
        <div class="header-body">
            ...
            <div class="header pb-4">
                <div class="container-fluid">
                    <div class="header-body">
                        <h6 class="h2 text-white d-inline-block mb-0"><i class="fas fa-history"></i> {{__('Request History')}}
                        </h6>
                    </div>
                </div>
            </div>
            {{-- <div class="row">
                <div class="col-xl-12 col-lg-12">
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-header"><strong>Search Request History</strong>
                            ...
                            <form method="GET" action="https://wpc15.com/admin/agentadmin/walletstationlogs"
                                ...
                                <div class="form-group mx-sm-1 mb-0"><select name="load_to" id="load_to"
                                        ...
                                        @foreach ($players as $player)
                                            <option value="{{ @$player->id }}" class="text-info">
                                                {{ @$player->username }}
                                            </option>
                                        @endforeach
                                    </select></div>
