    ...
    <div class="container-fluid">
        <div class="header-body">
            ...
            <div class="header pb-4">
                <div class="container-fluid">
                    <div class="header-body">
                        <h6 class="h2 text-white d-inline-block mb-0"><i class="fas fa-wallet"></i> Comission Management
                        </h6>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span
                                        class="h2 font-weight-bold mb-0">{{ isset(auth()->user()->wallet->comission) ? auth()->user()->wallet->comission : 0 }}</span>
                                </div>
                                <div class="col-auto">
