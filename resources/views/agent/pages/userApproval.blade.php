...
@section('content')
    @include('layouts.agentNavbars.headers.cardsUserApproval')
    <div class="container-fluid mt--7">
        ...
        <form
            action="{{ auth()->user()->user_level == 'admin' ? route('admin-user-approval-confirm') : route('user-approval-confirm') }}"
            id="user-accept" method="post" hidden>
            @csrf
