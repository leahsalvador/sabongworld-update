                        ...
                        <div class="card-header bg-transparent">
                            ...
                            <div class="row m-0">
                                <div class="col-sm-6 col-md-6">
                                    <h3 class=""><i class="fa fa-list"></i>
                                        {{__('LIST OF')}} {{__('AGENTS')}}
                                    </h3>
                                </div>
                            ...
                            <div class="table-responsive">
                                <div>
                                    <table class="table table-responsive align-items-center " id="example" style="min-height: 150px">
                                        <thead class="thead-light">
                                        <tr>
                                            <th scope="col" class="sort" data-sort="details">{{__('DETAILS')}}</th>
                                            <th scope="col" class="sort"
                                                data-sort="points">{{__('CURRENT POINTS')}}</th>
                                            <th scope="col" class="sort"
                                                data-sort="points">{{__('CURRENT COMISSION')}}</th>


                                            <th scope="col" class="sort" data-sort="date">{{__('DATE REGISTERED')}}</th>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div
                                                                ...
                                                                @if (auth()->user()->user_level == 'master-agent')
                                                                    <a class="dropdown-item" style="cursor: pointer;"
                                                                       onclick="changeUserLevel({{ @$user->id }},'{{ @$user->name }}','{{ @$user->user_level == 'sub-agent' ? __('master-agent-player') : __('sub-agent') }}')"><i
                                                                            class="fa fa-exchange-alt"></i>
                                                                        {{ @$user->user_level == 'sub-agent' ? __('Change to Player') : __('Change to Agent') }}
                                                                    </a>

                                                                @elseif (auth()->user()->user_level == 'sub-agent')
                                                                    <a class="dropdown-item" style="cursor: pointer;"
                                                                       onclick="changeUserLevel({{ @$user->id }},'{{ @$user->name }}','sub-agent-player')">
                                                                        <i class="fa fa-exchange-alt"></i>
                                                                        {{ __('Change to Player') }}
                                                                    </a>
                                                                @elseif (auth()->user()->user_level == 'gold-agent')
                                                                    <a class="dropdown-item" style="cursor: pointer;"
                                                                       onclick="changeUserLevel({{ @$user->id }},'{{ @$user->name }}','gold-agent-player')">
                                                                        <i class="fa fa-exchange-alt"></i>
                                                                        {{ __('Change to Player') }}
                                                                    </a>
                                                                @endif
