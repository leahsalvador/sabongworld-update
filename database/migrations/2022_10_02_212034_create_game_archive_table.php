...
class CreateGameArchiveTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('game_archive', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('status', ['upcoming', 'open', 'closed', 'done', 'cancelled', 'final-bet','draw','undo']);
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('game_archive');
    }
}
