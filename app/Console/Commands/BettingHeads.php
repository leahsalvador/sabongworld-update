...
class BettingHeads extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'betting:meron {loop=10}';
     ...
     * @var string
     */
    protected $description = 'This is auto betting script. This bot script automaticaly bet on running game for MERON.';
    ...
    public function handle()
    {
        ...
        $botIds = config('settings.bots.meron');
